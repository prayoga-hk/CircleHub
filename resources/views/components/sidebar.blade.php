<aside class="w-64 bg-[#141824] border-r border-slate-800/60 flex flex-col justify-between p-6 h-screen sticky top-0 shrink-0">
    ...
    <div class="space-y-8">
        ...
        <nav class="space-y-2 text-sm">
            <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-white bg-[#1D2132] font-medium transition">
    ...
    <div class="space-y-2 text-sm pt-4 border-t border-slate-800/60">
        <!-- LINK PROFIL KITA PASANG DI SINI -->
        <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800/40 transition">
            <svg class="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
            Akun
        </a>
        
        <!-- LOGOUT KITA PASANG DI SINI -->
