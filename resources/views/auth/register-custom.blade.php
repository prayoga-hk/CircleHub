        ...
        <div class="w-full max-w-md flex-shrink-0">
            <div class="w-full bg-[#161f33] p-6 sm:p-8 rounded-2xl border border-slate-800 shadow-xl">
                ...
                <div class="text-center mb-5">
                    ...
                    <span class="text-xl font-extrabold text-[#6C5CE7]">CircleHub</span>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-3.5">
                    ...
                    <div>
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus placeholder="Masukkan username"
                            class="w-full px-3.5 py-2.5 bg-[#0b1120] text-white rounded-xl border border-slate-700/70 focus:outline-none focus:border-[#6C5CE7] focus:ring-1 focus:ring-[#6C5CE7] font-medium text-sm transition">
                    ...
                    <div class="pt-2">
                        <button type="submit" 
                            class="w-full py-3 bg-[#6C5CE7] hover:bg-[#5b4bc4] text-white font-semibold rounded-xl transition duration-200 shadow-md shadow-[#6C5CE7]/20 active:scale-[0.99]">
                            Daftar Sekarang
                        </button>
                    </div>
                    ...
                    <p class="text-center text-xs text-slate-400 pt-1">
                        Sudah punya akun? 
                        <a href="{{ route('login') }}" class="text-[#6C5CE7] font-semibold hover:underline">Masuk di sini</a>
                    </p>
                </form>
